...
import com.seifernet.skullkeeper.persistence.SessionFactoryManager;
...
public abstract class GenericDAO <T, PK extends Serializable>{
	...
	private static final String LOGGER_ERROR_HIBERNATE = "Error on hibernate operations";
	...
	public PK create( T object ) {
		...
		try{
			...
			logger.error( LOGGER_ERROR_HIBERNATE );
